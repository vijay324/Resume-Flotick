  ...
  return (
    <div className="lg:hidden">
      <Button
        variant="outline"
        size="icon"
        className="h-10 w-10 bg-white shadow-md border-zinc-200"
          ...
          <div className="relative w-3/4 max-w-xs bg-white h-full shadow-2xl p-6 flex flex-col gap-6 animate-in slide-in-from-right duration-300">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                 <div className="h-10 w-10 rounded-lg bg-white border border-zinc-200 flex items-center justify-center text-white font-bold text-xs ring-2 ring-white shadow-sm">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 -mr-2 text-zinc-400 hover:text-zinc-900"
                onClick={() => setIsOpen(false)}
              >
                <X className="h-5 w-5" />
              </Button>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-4 bg-zinc-50 p-3 rounded-lg border border-zinc-100 justify-center">
                   <Button
                    variant="ghost"
                    size="sm"
