...
export function ClassicTemplate({ resumeData }: TemplateProps) {
  ...
  return (
    <div 
      id="resume-preview" 
      className="bg-white shadow-none p-[40px] md:p-[50px] min-h-[297mm] w-[210mm] text-[10.5pt] leading-[1.45] text-[#1a1a1a] print:min-h-0 print:h-auto print:shadow-none print:w-full print:p-[30px]"
