...
export function CertificationForm() {
  ...
  const confirmDelete = () => {
    ...
    updateSection("certifications", certifications.filter((i) => i.id !== deleteId));
    setDeleteId(null);
  };
  ...
  return (
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Button onClick={addCertification} variant="outline" className="w-full h-11 border-dashed border-zinc-300 text-zinc-500 hover:text-indigo-600 hover:border-indigo-300 hover:bg-indigo-50/50 rounded-xl transition-all">
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to remove this certification? This action cannot be undone."
        confirmText="Remove"
        variant="danger"
      />
    </div>
