...
const sampleResumeData: ResumeData = {
  ...
  skills: [
    { id: "skill-1", name: "React / Next.js" },
    { id: "skill-2", name: "TypeScript" },
    { id: "skill-3", name: "Node.js" },
    { id: "skill-4", name: "Python" },
    { id: "skill-5", name: "PostgreSQL / MongoDB" },
    { id: "skill-6", name: "AWS / GCP" },
    { id: "skill-7", name: "Docker / Kubernetes" },
    { id: "skill-8", name: "GraphQL" },
    { id: "skill-9", name: "Redis" },
    { id: "skill-10", name: "CI/CD Pipelines" },
  ],
  projects: [
    {
      id: "proj-1",
